...
<body>
    ...
    ?>
        ...
        <footer class="footer">
          <div class="container">
            <div class="row text-center">
              <p class="text-muted hidden-xs" id="partners">En partenariat avec <a href="http://www.lavenirdelartois.fr" target="_blank"><img src="img/partners/logo-avenir-arras.png" width="120px"></a> et réalisé par le <a href="https://twitter.com/polecom_arras" target="_blank"><img src="img/partners/logo-polecom.png" height="40px"></a> - <a href="http://www.epsi.fr" target="_blank"><img src="img/partners/epsi.PNG" height="40px"></a> - Arras</p>
              <p class="text-muted visible-xs" id="partners">
                <a href="http://www.lavenirdelartois.fr" target="_blank"><img src="img/partners/logo-avenir-arras.png" width="120px"></a>
                <a href="https://twitter.com/polecom_arras" target="_blank"><img src="img/partners/logo-polecom.png" height="40px"></a>
                <a href="http://www.epsi.fr" target="_blank"><img src="img/partners/epsi.PNG" height="40px"></a>
              </p>
            </div>
          </div>
        </footer>
